tinymce.ThemeManager.add("modern", function (e) {
    function t() {
        function t(t) {
            ...
            if (t)return d(t.split(/[ ,]/), function (t) {
                ...
                var r;
                "|" == t ? n = null : c.has(t) ? (t = {type: t}, u.toolbar_items_size && (t.size = u.toolbar_items_size), o.push(t), n = null) : (n || (n = {type: "buttongroup", items: []}, o.push(n)), e.buttons[t] && (r = t, t = e.buttons[r], "function" == typeof t && (t = t()), t.type = t.type || "button", u.toolbar_items_size && (t.size = u.toolbar_items_size), t = c.create(t), n.items.push(t), e.initialized ? i() : e.on("init", i)))
        ...
        return i.length || u.toolbar === !1 || t(u.toolbar || f), i.length ? {type: "panel", layout: "stack", classes: "toolbar-grp", ariaRoot: !0, ariaRemember: !0, items: i} : void 0
    }
    ...
    function o(t, i) {
        ...
        var o, r, a, s;
        o = e.getContainer(), r = e.getContentAreaContainer().firstChild, a = n(o), s = n(r), null !== t && (t = Math.max(u.min_width || 100, t), t = Math.min(u.max_width || 65535, t), m.setStyle(o, "width", t + (a.width - s.width)), m.setStyle(r, "width", t)), i = Math.max(u.min_height || 100, i), i = Math.min(u.max_height || 65535, i), m.setStyle(r, "height", i), e.fire("ResizeEditor")
    }
    ...
    function a(o) {
        function r() {
            if (h && h.moveRel && h.visible() && !h._fixed) {
                ...
                h.fixed(!1).moveRel(i, e.rtl ? ["tr-br", "br-tr"] : ["tl-bl", "bl-tl", "tr-br"]).moveBy(n, o)
            }
        }
    ...
    function s(r) {
        ...
        }}), u.statusbar !== !1 && a.add({type: "panel", name: "statusbar", classes: "statusbar", layout: "flow", border: "1 0 0 0", ariaRoot: !0, items: [
            {type: "elementpath"},
            s
